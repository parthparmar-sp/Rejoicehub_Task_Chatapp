...
export const AUTH_ROUTES="https://rejoicehub-task-chatapp-backend.onrender.com/api/auth";
export const SINGNUP_ROUTE=`${AUTH_ROUTES}/signup`;
export const LOGIN_ROUTES=`${AUTH_ROUTES}/login`;
export const AUDIT_ROUTES="https://rejoicehub-task-chatapp-backend.onrender.com/api/auth/audit";
export const USER_INFO="https://rejoicehub-task-chatapp-backend.onrender.com/api/auth/userinfo"
...
export const CONTACTS_ROUTES='https://rejoicehub-task-chatapp-backend.onrender.com/api/contacts';
...
export const MESSAGES_ROUTES='https://rejoicehub-task-chatapp-backend.onrender.com/api/messages/';
...
export const CHANNEL_ROUTES='https://rejoicehub-task-chatapp-backend.onrender.com/api/channel/'
